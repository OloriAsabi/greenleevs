  ...
  <div className="container mx-auto p-6">
    <div className="grid lg:grid-cols-4 footerBg gap-10 sm:grid-cols-2 md:grid-cols-2 ">
      <div className="mb-6  text-start">
        ...
        <ul className="list-none normal-case mb-0 space-y-10 font-normal text-white">
          <li>
      ...
      <div className="mb-6  text-start">
        <h5 className="uppercase font-bold mb-2.5 text-white">POLICIES</h5>
      ...
      <div className="mb-6  text-start">
        <h5 className="uppercase font-bold mb-2.5 text-white">CONTACT US</h5>
